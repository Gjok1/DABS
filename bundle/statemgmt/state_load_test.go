...
func TestStateToBundleEmptyLocalResources(t *testing.T) {
	...
	assert.Equal(t, "1", config.Resources.Tables["test_table"].ID)
	assert.Equal(t, resources.ModifiedStatusDeleted, config.Resources.Tables["test_table"].ModifiedStatus)
...
func TestStateToBundleEmptyRemoteResources(t *testing.T) {
	config := config.Root{
		Resources: config.Resources{
			...
			Tables: map[string]*resources.Table{
				"test_table": {
					Name:        "test_table",
					CatalogName: "main",
					SchemaName:  "default",
	...
	assert.Equal(t, "", config.Resources.Tables["test_table"].ID)
	assert.Equal(t, resources.ModifiedStatusCreated, config.Resources.Tables["test_table"].ModifiedStatus)
...
func TestStateToBundleModifiedResources(t *testing.T) {
	...
	assert.Equal(t, "1", config.Resources.Tables["test_table"].ID)
	assert.Equal(t, "", config.Resources.Tables["test_table"].ModifiedStatus)
	assert.Equal(t, "2", config.Resources.Tables["test_table_old"].ID)
	assert.Equal(t, resources.ModifiedStatusDeleted, config.Resources.Tables["test_table_old"].ModifiedStatus)
	assert.Equal(t, "", config.Resources.Tables["test_table_new"].ID)
	assert.Equal(t, resources.ModifiedStatusCreated, config.Resources.Tables["test_table_new"].ModifiedStatus)
